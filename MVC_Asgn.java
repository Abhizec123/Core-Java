/*Leveraging MVC architecture, following program is retrieves employee data, 
update and display view. Write only the missing part in the answer window so that the 
whole program can generate the expected view as illustrated in the example.
Avoid re-writing the entire code as the following part is already stored in the system:
...
public class MVC_Asgn
 {
    public static void main(String[] args)
    {
		...
		int newSal = (int) (controller.getEmployeeSalary() * 1.1) ; // 10% hike
